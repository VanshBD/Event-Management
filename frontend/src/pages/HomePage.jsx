...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto mt-8">
      {/* Filter UI */}
      <div className="flex flex-wrap justify-between items-center mb-8 p-4 border rounded-lg shadow-sm bg-black bg-opacity-30 backdrop-blur-md">
        {/* Date Filter */}
        <div className="flex flex-col mb-4 sm:mb-0">
          ...
          <input
            ...
            className="w-full sm:w-auto p-2 border rounded-md text-gray-700 bg-gray-200 bg-opacity-70 backdrop-blur-md"
          />
        </div>
        ...
        <div className="flex flex-col mb-4 sm:mb-0">
          ...
          <input
            ...
            className="w-full sm:w-auto p-2 border rounded-md text-gray-700 bg-gray-200 bg-opacity-70 backdrop-blur-md placeholder-black" // Change placeholder color here
          />
        </div>
